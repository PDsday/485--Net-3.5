    ...
    public partial class Form3 : Form
    {
        ...
        public void Comment_Net_Link()
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(ex.Message + "！！！请重试下载。\r\n");
                enable_function();
            }
            finally
            {
        ...
        private void filebutton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        string path = pathtextBox.Text.Substring(0, i);//取当前目录的字符串第一个字符到最后一个斜杠所在位置。;//这一句有问题 
        ...
        private void load_file_onthepath()
        {
            try
            {
                ...
                {
                    MessageBoxMidle.Show("当前导入的程序有误！请重新导入正确的程序文件！", "文件错误");
                    enable_function();
                    return;
                }
        ...
        private void downbutton_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(pathtextBox.Text))
            {
               MessageBoxMidle.Show(this, "请选择您要下载的DSP.Bin文件！", "发送文件提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                toolStripStatusLabel1.Text = "请选择需要下载的DSP.BIN文件！";
                return;
            }
            //保存IP
            ...
            //保存文件地址
            RegistryKeyLi.WriteRegistryKey(this.pathtextBox.Text, Commentclass.CommentPublicResgistryKeyPath, Commentclass.CommentDspResgistryKeyName);
            ...
            {          
                if (Step_One)
                {
                    ...
                    if (LinkCount >= 4)
                    {
                        ...
                        timer1.Stop();
                        enable_function();
                        MessageBoxMidle.Show(this, "无响应或响应出错！请重试！", "提示");
                    }
                }
                else if (Step_Tow)
                {
        ...
        private void Close_SocketTr()
        {
            Connect = false;
                ...
                catch (Exception ex)
                {
                    ...
                    sockClient.Close();
                    SocketOn = false;
                    Console.WriteLine("Close_SocketTr"+ex.Message);
                }
            ...
            try
            {
                ...
                {  
                    ...
                    if (netconnect == 5)
                    {
                        ...
                        {
                            MessageBox.Show("网络错误！请检查网络连接是否正常？IP地址设置是否正确？\r\n","提示");
                        }
                        this.toolStripStatusLabel1.Text = "连接失败，请检查网线与硬件是否正常。";
                    }
                }
                if (SocketOn)
                {
        ...
        private void David_Form3_Load(object sender, EventArgs e)
        {
        ...
        void Admin_UI()
        {
            ...
            this.cir_lode_Label2.Text = " ";
            this.cir_lode_Label2.BackColor = Color.Transparent;
        ...
        private void 以太网测试ToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
        ...
        private void ipaddres_KeyUp(object sender, KeyEventArgs e)
        {
            Commentclass.CommentIP = ipaddres.Text;
            RegistryKeyLi.WriteRegistryKey(Commentclass.CommentIP, Commentclass.CommentPublicResgistryKeyPath, "CommentIP");
        }
        ...
        private void toolStripMenuItem5_Click(object sender, EventArgs e)
        {
           ...
           // form9.Location = new Point(this.Location.X, this.Location.Y);
            form9.Show();
        }
    }
